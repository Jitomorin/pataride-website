      ...
      <div className="w-full h-15 p-1 bg-white  shadow-md rounded-xl rounded-bl-none rounded-br-none">
        <div className="flex p-2 align-middle items-center">
          ...
          <div className="flex-grow p-2">
            <div className="text-md textblack font-normal">
              Rey Jhon A. Baquirin{" "}
            </div>
          </div>
          <div className="p-2 text-black cursor-pointer transition-all ease-in-out hover:scale-[1.03] hover:text-white rounded-full">
            <svg
        ...
        <div className="flex items-center">
          ...
          <div className="search-chat flex flex-grow p-2">
            ...
            <div className="bg-gray-100 dark:bg-gray-800 dark:text-gray-200  flex justify-center items-center text-gray-400 rounded-r-md">
              <button className="bg-transparent text-[#f8d521] hover:scale-[1.03] text-lg transition-all ease-in-out font-semibold">
                Send
              </button>
            </div>
          </div>
