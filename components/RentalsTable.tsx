...
export default function RentalsTable({ rentals }: any) {
  ...
  console.log("filterd rentals", filteredRentals);
    ...
    <div className="w-full">
      ...
      <div className="lg:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">A list of all rentals.</p>
          <input
            type="text"
          ...
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <table className="min-w-full divide-y divide-gray-300">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {filteredRentals.length > 0 ? (
                  <>
                    {filteredRentals.map((person: any) => (
                      <tr key={person.uid}>
