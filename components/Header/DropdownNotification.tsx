  ...
  return (
    <li className="relative">
      ...
      <div
        ...
        className={`absolute -right-27 mt-2 flex  h-90 w-75 flex-col rounded-sm border border-stroke bg-green-100 z-[99999] shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 ${
