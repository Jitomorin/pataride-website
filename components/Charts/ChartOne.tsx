...
const ChartOne: React.FC = () => {
  const [state, setState] = useState<ChartOneState>({
    series: [
      {
        name: "KAV 123",
        data: [23, 11, 22, 0, 13, 22, 37, 10, 0, 22, 5, 45],
      },

      {
        name: "KAV 124",
        data: [30, 25, 6, 3, 0, 35, 64, 52, 59, 0, 39, 51],
      },
      {
        name: "KAV 125",
        data: [3, 4, 60, 30, 70, 25, 84, 59, 29, 12, 0, 51],
      },
    ],
  });
  ...
  return (
    <div className="col-span-12 rounded-md shadow-md bg-white px-5 pb-5 pt-7 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7 xl:col-span-8">
