        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <p>
                  Provide the client with this confirmation code in order to
              ...
              <ModalFooter>
                ...
                <Button
                  color="primary"
                  onPress={async () => {
                    checkIfChatExists(order.rental.userID, order.userID).then(
                      (result: any) => {
                        if (result.length !== 0) {
                          ...
                          addDataWithDocName("chats", uid, {
                            ...
                            userID: user.uid,
                            users: [order.userID, order.rental.userID],
                            uid,
                          }).then(() => {
                            // send message
